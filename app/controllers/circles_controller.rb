class CirclesController < ApplicationController
  ...
  private
    ...
    def preprocessing
      params[:circle][:people_scale] = params[:circle][:people_scale].delete("^0-9").to_i if params[:circle][:people_scale]
      params[:circle][:annual_fee]   = params[:circle][:annual_fee].delete("^0-9").to_i   if params[:circle][:annual_fee]
    end
